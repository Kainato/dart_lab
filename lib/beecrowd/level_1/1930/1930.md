...
Implementa algoritmo de redução usando `reduce()` para somar todas as tomadas, subtraindo 3 unidades (as tomadas originais das 2 réguas mais uma já conectada).
