...
Lê quantidade de casos de teste. Para cada caso, divide dois números e verifica divisão por zero, formatando resultado com `toStringAsFixed(1)` ou retornando mensagem de erro.
