...
A solução para o problema 1257 foi implementada da seguinte forma:

• Utiliza programação assíncrona para processar dados
• Implementa loops para iteração sobre dados
• Utiliza estruturas condicionais para lógica de decisão

O código está implementado no arquivo `1257.dart` na mesma pasta, utilizando a linguagem Dart com as melhores práticas de clareza e eficiência.
