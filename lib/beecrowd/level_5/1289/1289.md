...
Implementa cálculo de probabilidade geométrica usando fórmula: P(i) = p × (1-p)^(i-1) / (1-(1-p)^n). Trata casos especiais (p=0 e p=1) e formata resultado com 4 casas decimais.
