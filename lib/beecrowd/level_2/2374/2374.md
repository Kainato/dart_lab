...
A solução para o problema 2374 foi implementada da seguinte forma:

• Implementa uma solução direta e eficiente

O código está implementado no arquivo `2374.dart` na mesma pasta, utilizando a linguagem Dart com as melhores práticas de clareza e eficiência.
